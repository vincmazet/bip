...
A common problem in image processing concerns the detection and localization
of specific "objects" in the image.
This corresponds to extracting high-level information that has a meaning for the user,
in contrast to low-level information related to pixels.
...
Feature detection is often a first step in real applications, such as measuring the size of an object,
